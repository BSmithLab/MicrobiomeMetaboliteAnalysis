...
Remove_LowRT = c(0,2.04,2.3,2.38,2.937,3.34,3.567,4.51,4.95,6.01,7.47,7.831,7.95,8.235,8.72,9.3,9.861,12.02) #Not needed, if ClearNoise = False
Remove_HighRT = c(1.94,2.179,2.37,2.884,3.085,3.5,3.772,4.88,5.21,6.64,7.475,7.908,7.97,8.52,8.74,9.748,10,15.6) #Not needed, if ClearNoise = False
