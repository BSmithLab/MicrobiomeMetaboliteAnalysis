...
Remove_LowRT = c(0,3.29,4.48,5.01,5.1,6.45,6.727,6.77,7.33,7.9,8.27,8.434,8.46,8.58,8.67,9.305,9.4,9.58,10.1,10.565,10.67,10.83,10.95,11.03,11.144,11.22,11.3,11.43,11.65,12) #Not needed, if ClearNoise = False
Remove_HighRT = c(3.115,3.53,4.95,5.07,5.31,6.66,6.75,6.78,7.61,7.915,8.406,8.436,8.49,8.595,8.68,9.308,9.41,9.75,10.39,10.635,10.68,10.902,10.99,11.083,11.148,11.253,11.33,11.58,11.94,15.6) #Not needed, if ClearNoise = False
