...
Remove_LowRT = c(10.3) #Not needed, if ClearNoise = False
Remove_HighRT = c(15.5) #Not needed, if ClearNoise = False
...
OD600_pos = c(0.056,0.025,0.023,0.034)
OD600_neg = c(0.031,0.092,0.033)
...
heatcolorlow = "deepskyblue"
heatcolormid = "white"
heatcolorhigh = "darkorange1"
limits = c(-3,3)
clusterrows = T
clustercols = T
