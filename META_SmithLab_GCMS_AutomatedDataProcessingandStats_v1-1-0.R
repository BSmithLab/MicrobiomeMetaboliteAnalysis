...
#V2-0-0: Statistics and bar plot functionality added
...
ExperimentOrder = c("ELenta","EFaecalis","CSporogenes") #These must be the same as the "organism" object in the previous script (CASE SENSITIVE)
...
specificExpCond = T
PCAfocus = "Pos"  #THIS MUST BE ONE OF THE FOUR VALID STRINGS PROVIDED IN "CONDITIONS" OBJECT (ABOVE)
...
piecolorfnc = colorRampPalette(c("red","yellow","green","blue","pink")) #You can select as many or as few colors as you would like. The color order can be in any order you like.
