...
Remove_LowRT = c(0,1.56,1.715,1.865,2.05,2.38,2.68,3.314,4.5,5.53,6.11,6.251,6.65,7.36,7.47,7.835,8.033,8.36,9.91,13.1) #Not needed, if ClearNoise = False
Remove_HighRT = c(1.4,1.67,1.83,1.91,2.31,2.616,3.22,4.38,5.14,5.985,6.15,6.34,6.87,7.39,7.69,7.93,8.23,8.37,9.92,15.7) #Not needed, if ClearNoise = False
  ...
  if(FilterBefore == T){
    ...
    if(combinebroadpeaks == T){
      ...
      for(z in 1:nrow(RTind)){
        cleandata2$RT[z] = mean(RTind$Start[z],RTind$Stop[z])
      }
